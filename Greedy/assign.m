...
function [Flight,Gate] = assign(Flight,Gate)
...
for i = 1:size(Gate,1)
    if(Gate{i,5}==0)
        ...
        if (Arrive_Check&&Leave_Check&&Type_Check&&Assign_Done == 0)
            Gate{i,5} = 1;
            Gate{i,6} = Gate{i,6}+1;
            Gate{i,7} = Flight{1,8};
            Gate{i,8} = Flight{1,1};
            ...
            Assign_Done = 1;    % 完成分配
            break
        else if (Arrive_Check2&&Leave_Check&&Type_Check)||(Arrive_Check&&Leave_Check2&&Type_Check)&&(Assign_Done == 0)
                Gate{i,5} = 1;
            Gate{i,6} = Gate{i,6}+1;
            Gate{i,7} = Flight{1,8};
            Flight{1,12} = 1;
            ...
            Assign_Done = 1;    % 完成分配
            break
        else if (Arrive_Check2&&Leave_Check2&&Type_Check&&(Assign_Done==0))
                Gate{i,5} = 1;
            Gate{i,6} = Gate{i,6}+1;
            Gate{i,7} = Flight{1,8};
            Flight{1,12} = 1;
